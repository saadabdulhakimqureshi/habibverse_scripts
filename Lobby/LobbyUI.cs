/// <summary>
/// LobbyUI - Lobby User Interface Manager
/// 
/// Manages the main lobby UI including player list display and lobby controls.
/// Coordinates UI updates with lobby state changes.
/// 
/// Features:
/// - Player list UI display
/// - Lobby controls (start game, leave, etc.)
/// - Chat integration
/// - Ready state display
